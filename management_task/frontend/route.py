...
class Route:
    ...
    def switch_page(e, point, pg):
        ...
        for page in Route.SWITCH_CONTROL:
            print(f'page: {page}')
        ...
        # print(f'INI ISINYA: {Route.SWITCH_CONTROL[point]}')
        # pg.add(Route.SWITCH_CONTROL[point])
        # for page in Route.SWITCH_CONTROL:
        #     print(f'page : {page}')
        #     Route.SWITCH_CONTROL[page](pg).offset.x = 2
        #     # pg.add(Route.SWITCH_CONTROL[page])
        #     Route.SWITCH_CONTROL[page](pg).update()

        # Route.SWITCH_CONTROL[point](pg).offset.x = 0
        # # pg.add(Route.SWITCH_CONTROL[point])
        # Route.SWITCH_CONTROL[point](pg).update()